import { users, prayers, intentions, type User, type InsertUser, type Prayer, type InsertPrayer, type Intention, type InsertIntention } from "@shared/schema";
...
export interface IStorage {
  ...
  // Prayer methods
  getUserPrayers(userId: number): Promise<Prayer[]>;
  createPrayer(prayer: InsertPrayer): Promise<Prayer>;
  updatePrayerCompleted(id: number, completed: boolean): Promise<Prayer | undefined>;
  
  // Intention methods
  getUserIntentions(userId: number): Promise<Intention[]>;
  createIntention(intention: InsertIntention): Promise<Intention>;
  deleteIntention(id: number, userId: number): Promise<boolean>;
  updateIntentionStatus(id: number, userId: number, isActive: boolean): Promise<Intention | undefined>;
}
