...
export const rosaryContent: Record<string, any> = {
  initium: {
    title: "Initium",
    subtitle: "Início da Santa Oração",
    latin: "Initium Sanctae Orationis",
    sections: [
      {
        title: "Signum Crucis",
        icon: "fas fa-cross",
        latin: `Per signum crucis de inimicis nostris<br>
      ...
      },
      {
        ...
        icon: "fas fa-angel",
        latin: `Sancte Angele Custos, cum omni amore et fiducia, Te rogamus ut adsistas et juncti nobiscum hoc rosarium recites, ut digni efficiamur promissionibus Christi. Amen.`,
        portuguese: `Santo Anjo da Guarda, com todo amor e confiança, Vos pedimos para que estejais conosco rezando este terço, para que sejamos dignos das promessas de Cristo. Amém.`
      },
      {
      ...
      },
      {
        title: "3 Ave Maria",
        icon: "fas fa-praying-hands",
        latin: `Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.`,
        portuguese: `Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
  ...
  dolorosa: {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: "fas fa-cross",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem in honórem Tuæ crudélis verberatiónis. A te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, plénam refrenatiónem nostrórum sénsuum. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                <strong>Gloria Patri:</strong><br>
                Gloria Patri, et Filio, et Spiritui Sancto. Sicut erat in principio, et nunc, et semper, et in saecula saeculorum. Amen.<br><br>
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta segunda dezena para honrar a Vossa cruel flagelação, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, a mortificação de nossos sentidos. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
                     <strong>Glória ao Pai:</strong><br>
                     Glória ao Pai, e ao Filho, e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.<br><br>
                     <strong>Oração de Fátima:</strong><br>
                     Oh meu Jesus, perdoai-nos, livrai-nos do fogo do inferno, levai as almas todas para o Céu e socorrei principalmente as que mais precisarem da Vossa divine Misericórdia. Amém.`
      },
      {
        title: "III. Coronatio Spinis",
        icon: "fas fa-crown-of-thorns",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem Tuæ crudélis coronatiónis spinórum. A te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, mágnam contemptiónem mundi. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta terceira dezena para honrar a vossa cruel coroação de espinhos, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, o desprezo do mundo. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        ...
        icon: "fas fa-cross",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem Tuæ itíneris oneráti cruce ad montem calvárium. A te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, mágnam patiéntiam in ómnibus nostris crúcibus. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta quarta dezena para honrar o carregamento da cruz até o monte Calvário, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, a paciência em todas as nossas cruzes. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        title: "V. Crucifixio",
        icon: "fas fa-cross",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem Tuæ crucifixiónis et mórtis ignominiósæ in Mónte Calvário. A Te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, conversiónem peccatórum, perseverántiam iustórum et solácium animárum purgatórii. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta quinta dezena para honrar a vossa crucificação e morte ignominiosa no monte Calvário, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, a conversão dos pecadores, a perseverança dos justos e o alívio das almas do purgatório. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
    ...
    sections: [
      {
        title: "I. Resurrectio",
        icon: "fas fa-cross",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem Tuæ gloriósæ resurretiónis. A Te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, amórem Dei et divínum ardórem Tui Sancti ministérii. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta primeira dezena para honrar a vossa gloriosa ressurreição, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, o amor a Deus e o fervor no Vosso serviço. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        title: "II. Ascensio",
        icon: "fas fa-cloud",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem Tuæ ascentiónis triunphális in cælum. A Te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, férvidum desidérium cæli, nostræ diléctæ pátriæ. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta segunda dezena para honrar a Vossa triunfante ascenção, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, um ardente desejo do Céu, nossa querida pátria. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        ...
        icon: "fas fa-fire",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem mistérii Pentecóstes. A Te pétimus, hoc mystério et intercessióne Tuæ Sanctissimæ Matris, descénsum Spiritus Sancti in nostras animas. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta terceira dezena para honrar o mistério de Pentecostes, e Vos pedimos, por este mistério e pela intercessão de Vossa Mãe Santíssima, a descida do Espírito Santo em nossas almas. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        ...
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem ressurrectionis et triumphális assumptiónis Tuæ Sanctissimæ Matris in cælo. A Te pétimus, hoc mystério et intercessióne éius, téneram devotiónem erga tam bonam matrem. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta quarta dezena para honrar a ressurreição e triunfal assunção de Vossa Santíssima Mãe ao Céu, e Vos pedimos, por este mistério e por sua intercessão, uma terna devoção a tão boa Mãe. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
      ...
      },
      {
        title: "V. Coronatio",
        icon: "fas fa-crown",
        latin: `Tibi offérimus, Domine Iésu, hanc decádem, in honórem corónæ inductiónis gloriæ Tuæ Sanctissimæ Matris in cælo. A Te pétimus, hoc mystério et intercessióne éius, perseverántiam in gratia et corónam gloriæ. Ámen.<br><br>
                <strong>Pater Noster:</strong><br>
                Pater noster, qui es in caelis, sanctificetur nomen tuum. Adveniat regnum tuum. Fiat voluntas tua, sicut in caelo et in terra. Panem nostrum cotidianum da nobis hodie. Et dimitte nobis debita nostra, sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.<br><br>
                <strong>10 Ave Maria:</strong><br>
                Ave Maria, gratia plena, Dominus tecum. Benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.<br><br>
                ...
                <strong>Oratio Fatima:</strong><br>
                Oh Iesu mi, nos absolvi a peccátis nostris, libera nos ab ignibus infernorum. Omnes animas attrahe ad caelum, praesertim habentes maximam necessitatem. Amen.`,
        portuguese: `Nós Vos oferecemos, Senhor Jesus, esta quinta dezena para honrar a coroação gloriosa de Vossa Mãe Santíssima no Céu, e Vos pedimos, por este mistério e por sua intercessão, a perseverança na graça e a coroa da glória. Amém.<br><br>
                     <strong>Pai Nosso:</strong><br>
                     Pai Nosso, que estais nos céus, santificado seja o vosso nome; venha a nós o vosso reino; seja feita a vossa vontade, assim na terra como no céu. O pão nosso de cada dia nos dai hoje; perdoai-nos as nossas dívidas, assim como nós perdoamos os nossos devedores; e não nos deixeis cair em tentação, mas livrai-nos do mal. Amém.<br><br>
                     <strong>10 Ave Maria:</strong><br>
                     Ave Maria, cheia de graça, o Senhor é convosco; bendita sois vós entre as mulheres, e bendito é o fruto do vosso ventre, Jesus. Santa Maria, Mãe de Deus, rogai por nós pecadores, agora e na hora da nossa morte. Amém.<br><br>
